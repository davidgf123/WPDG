...
export default function FilterViews({title, content}){
  return (
...
export const OrderView=({data, filterName, filters, setFilters})=>{
        ...
        <View style={styles.flexRowWrap}>
            {
                data && data.map((item, index) =>{
                    ...
                    let backgroundColor = isActive? theme.colors.red: "white";
